...
const AdminDashboard: React.FC = () => {
  ...
  const { adminHostels } = useSelector((state: RootState) => state.admin);
  ...
  useEffect(() => {
    ...
    const cachedHostels = cacheService.get<Hostel[]>(cacheKey, 'local');
    ...
    adminHostelAPI
      ...
      .then((response) => {
        ...
        const hostels = Array.isArray(resp?.data?.hostels) ? resp.data.hostels : [];
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center gap-4">
              <div className="text-4xl">📋</div>
              <div>
                <h3 className="text-3xl font-bold text-orange-600">{adminHostels.reduce((sum, h) => sum + (h.pendingApplications || 0), 0)}</h3>
          ...
          {adminHostels.length === 0 ? (
            ...
            <>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                ...
                <div key={hostel._id || hostel.id} className="bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 overflow-hidden">
                  ...
                  <div className="p-6">
                    ...
                    <div className="grid grid-cols-2 gap-3 mb-4">
                      ...
                      <div className="bg-orange-50 p-3 rounded">
                        ...
                        <span className="text-lg font-bold text-orange-600">{hostel.pendingApplications || 0}</span>
                      </div>
                    </div>
